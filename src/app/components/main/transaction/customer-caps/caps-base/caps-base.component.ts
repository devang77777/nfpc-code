...
@Component({
  selector: 'app-caps-base',
  templateUrl: './caps-base.component.html',
  styleUrls: ['./caps-base.component.scss']
})
export class CapsBaseComponent extends BaseComponent {
 public isDetailVisible: boolean;
  ...
  openExportCredit() {
    const dialogRef = this.dialog.open(CapsExportComponent);
  }

  openImportCredit() {
    this.router.navigate(['transaction/customer-caps/', 'import']).then();
  }

  openUpdateCredit() {
    this.router.navigate(['transaction/customer-caps', 'update']).then();
  }
