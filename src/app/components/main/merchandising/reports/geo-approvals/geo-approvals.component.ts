...
@Component({
  selector: 'app-geo-approvals',
  templateUrl: './geo-approvals.component.html',
  styleUrls: ['./geo-approvals.component.scss'],
})
export class GeoApprovalsComponent implements OnInit {
