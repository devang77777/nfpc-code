...
@Component({
  ...
  styleUrls: ['./task-answers.component.scss'],
  animations: [
...
export class TaskAnswersComponent implements OnInit {
  ...
  public displayedColumns = ['created_at', 'task_name', 'survey_name', 'customer_code', 'customer_name', 'ans_completed', 'question', 'ans_type', 'ans'];
  dateFilterControl: FormControl;
  selectedColumnFilter: string;

  expandedElement: any | null;
  filterForm: FormGroup;
  constructor(public fb: FormBuilder, private merService: MerchandisingService, public dataEditor: DataEditor) {
