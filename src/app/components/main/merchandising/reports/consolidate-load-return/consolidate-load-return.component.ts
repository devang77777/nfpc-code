...
@Component({
  selector: 'app-consolidate-load-return',
  templateUrl: './consolidate-load-return.component.html',
  styleUrls: ['./consolidate-load-return.component.scss']
})
export class ConsolidateLoadReturnComponent implements OnInit {
