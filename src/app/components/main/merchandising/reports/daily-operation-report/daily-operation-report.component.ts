...
@Component({
  selector: 'app-daily-operation-report',
  templateUrl: './daily-operation-report.component.html',
  styleUrls: ['./daily-operation-report.component.scss']
})
export class DailyOperationReportComponent implements OnInit {
