...
@Component({
  selector: 'app-daily-cancel-order',
  templateUrl: './daily-cancel-order.component.html',
  styleUrls: ['./daily-cancel-order.component.scss']
})
export class DailyCancelOrderComponent implements OnInit {
