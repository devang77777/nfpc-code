...
@Component({
  selector: 'app-consolidated-load-report',
  templateUrl: './consolidated-load-report.component.html',
  styleUrls: ['./consolidated-load-report.component.scss']
})
export class ConsolidatedLoadReportComponent implements OnInit {

  @ViewChild(MatPaginator, { static: true }) paginator: MatPaginator;
  itemSource = new MatTableDataSource();
  private subscriptions: Subscription[] = [];
  public displayedColumns = ['SRNo', 'Item', 'Item_description', 'qty', 'uom', 'sec_qty', 'sec_uom', 'from_location', 'to_location', 'from_lot_serial', 'to_lot_number', 'to_lot_status_code', 'load_date', 'warehouse'];
