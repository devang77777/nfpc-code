...
@Component({
  selector: 'app-loading-chart-by-warehouse',
  templateUrl: './loading-chart-by-warehouse.component.html',
  styleUrls: ['./loading-chart-by-warehouse.component.scss']
})
export class LoadingChartByWarehouseComponent implements OnInit {
  @ViewChild(MatPaginator, { static: true }) paginator: MatPaginator;
  itemSource = new MatTableDataSource();
  private subscriptions: Subscription[] = [];
  public displayedColumns = ['prod_code', 'prod_desc', 'dmd_lower_upc', 'prv_rt_ctn', 'prv_rt_pcs', 'dmd_ctn', 'dmd_pcs', 'net_lss_ctn', 'net_lss_pcs'];
