...
@Component({
  selector: 'app-closed-visits',
  templateUrl: './closed-visits.component.html',
  styleUrls: ['./closed-visits.component.scss']
})
export class ClosedVisitsComponent implements OnInit {
  ...
  public displayedColumns = ['createdAt', 'name', 'location', 'total_task', 'completedTask', 'startTime', 'endTime', 'proximity'];
