...
@Component({
  selector: 'app-daily-grv-report',
  templateUrl: './daily-grv-report.component.html',
  styleUrls: ['./daily-grv-report.component.scss']
})
export class DailyGrvReportComponent implements OnInit {
