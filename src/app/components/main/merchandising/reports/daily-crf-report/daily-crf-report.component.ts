...
@Component({
  selector: 'app-daily-crf-report',
  templateUrl: './daily-crf-report.component.html',
  styleUrls: ['./daily-crf-report.component.scss']
})
export class DailyCrfReportComponent implements OnInit {
  @ViewChild(MatPaginator, { static: true }) paginator: MatPaginator;
  itemSource = new MatTableDataSource();
  private subscriptions: Subscription[] = [];
  columns = [
    { title: 'Row Label', columnDef: 'region_name' },
    { title: 'Total Orders', columnDef: 'totalorders' },
    { title: 'Total Invoiced', columnDef: 'totalinvoiced' },
    { title: 'Total Cancelled', columnDef: 'totalcancel' },
    { title: 'CFR%', columnDef: 'cfr' },
  ]
  displayedColumns = [];
