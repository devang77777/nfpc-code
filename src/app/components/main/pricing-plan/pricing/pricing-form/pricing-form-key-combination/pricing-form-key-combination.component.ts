...
@Component({
  selector: 'app-pricing-form-key-combination',
  templateUrl: './pricing-form-key-combination.component.html',
  styleUrls: ['./pricing-form-key-combination.component.scss'],
})
export class PricingFormKeyCombinationComponent implements OnInit, OnChanges {
  ...
  public lobFormControl: FormControl;
  ...
  public ngOnInit(): void {
    ...
    this.lobFormControl = new FormControl();
  ...
  public ngOnChanges() {
    ...
    if (this.editData) {
      ...
      if (this.editData.combination_key_value.includes('Item')) {
        this.itemFormGroup.get('item').setValue(true);
      }
      this.updateCheckbox();
    }
