...
type AOA = any[][];
@Component({
  selector: 'app-pricing-by-item-base-tab-import',
  templateUrl: './pricing-by-item-base-tab-import.component.html',
  styleUrls: ['./pricing-by-item-base-tab-import.component.scss']
})
export class PricingByItemBaseTabImportComponent implements OnInit {
  ...
  importData() {
    ...
    formData.append('item_base_price', this.fileInfo);

    this.api.uploadPricingByItemBaseImport(formData).subscribe((res: any) => {
      if (res.status) {
        this.backToMain();
