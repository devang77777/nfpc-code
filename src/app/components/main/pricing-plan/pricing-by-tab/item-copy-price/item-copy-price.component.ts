...
@Component({
  selector: 'app-item-copy-price',
  templateUrl: './item-copy-price.component.html',
  styleUrls: ['./item-copy-price.component.scss']
})
export class ItemCopyPriceComponent implements OnInit {
     ...
     importData() {
       ...
       formData.append('item_base_price_mapping', this.fileInfo);
   
       this.api.uploadCopyItemPricingByImport(formData).subscribe((res: any) => {
         if (res.status) {
           this.backToMain();
...
//   importData() {
//   // Send the file directly as binary
//   const body = {item_base_price_mapping : this.fileInfo}
//   const formData = new FormData();
//   formData.append('item_base_price_mapping',this.fileInfo)
...
//     if (res.status) {
//       this.backToMain();
//       this.commonToasterService.showSuccess('Success', res.message);
//     }
//   });
// }
// importData() {
//   if (!this.fileInfo) {
//     this.commonToasterService.showWarning('Warning', 'Please select a file before import');
//     return;
//   }

//   this.api.uploadCopyPricingByItem1(this.fileInfo).subscribe({
//     next: (res: any) => {
//       if (res.status) {
//         this.backToMain();
//         this.commonToasterService.showSuccess('Success', res.message);
//       } else {
//         this.commonToasterService.showWarning('Warning', res.message || 'Import failed');
//       }
//     },
//     error: () => {
//       this.commonToasterService.showError('Error', 'File import failed');
//     }
//   });
// }
