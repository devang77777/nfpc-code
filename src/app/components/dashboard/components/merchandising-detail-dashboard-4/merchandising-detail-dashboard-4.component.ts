...
@Component({
  selector: 'app-merchandising-detail-dashboard-4',
  templateUrl: './merchandising-detail-dashboard-4.component.html',
  styleUrls: ['./merchandising-detail-dashboard-4.component.scss'],
  animations: [
...
export class Merchandising4DetailComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //   this.service.getDashboard4FiltersData(body).subscribe((res) => {
  ...
  generateDetailsColumns(selected) {
    ...
    switch (selected) {
      ...
      case 'routeCompliance':
        ...
        this.displayedColumns = ['visit_date', 'merchandiserCode', 'merchandiserName', 'salesman_supervisor', 'regionalManager', 'journeyPlan', 'totalJourney', 'planedJourney', 'unPlanedJourney', 'journeyPlanPercent', 'unPlanedJourneyPercent'];
        break;
        case 'msl':
        // this.displayedColumns = ['visit_date', 'merchandiserCode', 'merchandiserName', 'salesman_supervisor', 'regionalManager', 'areaManager', 'journeyPlan', 'planedJourney', 'totalJourney', 'journeyPlanPercent', 'strikeCalls', 'strike_calls_percent', 'unPlanedJourney', 'unPlanedJourneyPercent'];
        this.displayedColumns = ['visit_date','customer_code', 'customer_name', 'merchandiser_code', 'merchandiser_name', 'supervisor_name', 'msl_item', 'out_of_stock_item', 'msl_compliance'];
        break;
        case 'customer':
          // this.displayedColumns = ['visit_date', 'merchandiserCode', 'merchandiserName', 'salesman_supervisor', 'regionalManager', 'areaManager', 'journeyPlan', 'planedJourney', 'totalJourney', 'journeyPlanPercent', 'strikeCalls', 'strike_calls_percent', 'unPlanedJourney', 'unPlanedJourneyPercent'];
          this.displayedColumns = ['item_code','item_name', 'out_of_stock_qty', 'model_stock_qty', 'msl_perform'];
          break;
      default:
        break;
    }
  ...
  openCustomerDetail(evt) {
    //this.showCustomerDetail = true;
    let body = {
      "customer_id" : evt.customer_id,
    "start_date": evt?.date,
    "end_date": evt?.end_date ?  evt?.end_date : '',
    "type": "msl-listing-details"
    };
    //this.dataTypes.forEach((item, index) =>{
      ...
      this.subscriptions.push(
        this.service.getDashboard4FiltersData(body).subscribe((dahsboard) => {
          ...
          this.custName = evt.customer_name
          this.customerDetails = dahsboard.dashboardData?.data;
          this.expandedElement = this.expandedElement === this.customerDetails ? null : this.customerDetails;
          this.showCustomerDetail = true;
          this.generateDetailsColumns('customer')
    ...
    // this.dataSource.paginator = this.paginator;
    // console.log("evt", evt);
    // this.customerDetails = evt
    // this.expandedElement = this.expandedElement === evt ? null : evt;
    // this.showCustomerDetail = true;
    // this.generateDetailsColumns('customer')
    // this.dataSource = new MatTableDataSource(this.displayedColumns);
  }
  ...
  onBackClick(){
    ...
    this.generateDetailsColumns('msl')
    this.dataSource = new MatTableDataSource(this.displayedColumns);
    this.getChartsData(this.selected);
  }
  ...
  applyFilter() {
    ...
    if(this.selected == 'msl'){
      this.getListingData(filterObj)
    }
  }
  ...
  getListingData(filterObj){
    filterObj.type = 'msl-listing';
    this.service.getDashboard4DataByFilter(filterObj).subscribe((res) => {
      this.dashboardData[this.selected].listing = res.data;
      this.getChartsData(this.selected);
    })
  }
  ...
  initChart1() {
    ...
    var chart = am4core.create('chartdiv111444', am4charts.XYChart);
  ...
  initChart2() {
    ...
    var chart = am4core.create('chartdiv222444', am4charts.XYChart);
  ...
  initChart3() {
    ...
    var chart = am4core.create('chartdiv333444', am4charts.RadarChart);
    chart.hiddenState.properties.opacity = 0; // this creates initial fade-in
